...
export const getTest = async (testName: string): Promise<any> => {
  try {
    ...
    const response = await axios.get(`http://127.0.0.1:8000/api/test/${testName}`, {
      headers: {
...
export const getTestByUserId = async (): Promise<any> => {
  try {
    ...
    const response = await axios.get(`http://127.0.0.1:8000/api/test/user`, {
      headers: {
        'Content-Type': 'application/json',
      },
      withCredentials: true,
...
export const updateQuestion = async (updateQuestion: Partial<Question>, question_id: string): Promise<any> => {
  try {
    ...
    const response = await axios.put(`http://127.0.0.1:8000/api/test/update/${question_id}`,updateQuestion ,{
...
export const getHistoryById = async (): Promise<any> => {
  try {
    const response = await axios.get(`http://127.0.0.1:8000/api/history/retrive`, {
      headers: {
        'Content-Type': 'application/json',
      },
      withCredentials: true,
...
export const createRoom = async (expiredTime: number): Promise<any> => {
  try {
    const response = await axios.post(`http://127.0.0.1:8000/api/room/create?expired_time=${expiredTime}`,{}, {
      headers: {
        'Content-Type': 'application/json',
      },
      withCredentials: true,
