...
import { resetGame } from '../../../app/store/slices/gameSlice';
...
const HostManagement: React.FC = () => {
  ...
  // Get initial tab from URL fragment or default to 'upload'
  const getInitialTab = () => {
    const hash = location.hash.replace('#', '');
    const validTabs = ['upload', 'view', 'setup', 'history'];
    return validTabs.includes(hash) ? hash : 'upload';
  };
          ...
          <div className="text-center mb-8 relative">
            ...
            <div className="absolute top-0 right-0">
              <Button
                ...
                className="shadow-md transition-all duration-200 hover:scale-105 font-medium"
              >
                Đăng xuất
              </Button>
            </div>
